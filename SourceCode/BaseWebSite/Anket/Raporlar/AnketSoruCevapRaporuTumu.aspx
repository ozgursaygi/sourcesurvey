<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnketSoruCevapRaporuTumu.aspx.cs" Inherits="BaseWebSite.Anket.Raporlar.AnketSoruCevapRaporuTumu1" %>
      ...
      <div class="page_report">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" 
                ondatabinding="ReportViewer1_DataBinding" Height="620px">
            <LocalReport ReportPath="Anket\Raporlar\AnketSoruCevapRaporuTumu.rdlc">
                <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              ...
              TypeName="BaseWebSite.Anket.Raporlar.AnketSoruCevapRaporuTumuTableAdapters.sbr_anket_soru_cevap_raporu_tumu_spTableAdapter">
                <SelectParameters>
