...
{
    public partial class AcikAnketSoruTipi1CevapRaporu1 : System.Web.UI.Page
    {
        ...
        protected void InitiliazeCombos()
        {
            ...
            {
                this.ddlAnket.DataSource = BaseDB.DBManager.AppConnection.GetDataSet("select * from sbr_anket_v where grup_uid in ('" + grup_uid + "') and anket_tipi_id=2 order by anket_adi");
        ...
        private void ShowReport()
        {
                ...
                if (this.ddlSoru.SelectedValue != null && this.ddlSoru.SelectedValue.ToString() != "")
                {
                    ...
                    if (soru_tipi_id == "1")
                    {
                        ...
                        this.ReportViewer1.LocalReport.ReportPath = "Anket\\Raporlar\\AcikAnketSoruTipi1CevapRaporu.rdlc";
        ...
        protected void ddlgrup_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlgrup.SelectedValue != null && ddlgrup.SelectedValue.ToString() != "")
            {
                this.ddlAnket.DataSource = BaseDB.DBManager.AppConnection.GetDataSet("select * from sbr_anket_v where grup_uid in ('" + ddlgrup.SelectedValue.ToString() + "') and anket_tipi_id=2  order by anket_adi");
                this.ddlAnket.DataTextField = "anket_adi";
                this.ddlAnket.DataValueField = "anket_uid";
                this.ddlAnket.DataBind();
            }
