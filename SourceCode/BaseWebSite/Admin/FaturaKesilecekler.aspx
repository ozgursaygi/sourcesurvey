<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaturaKesilecekler.aspx.cs" Inherits="BaseWebSite.Admin.FaturaKesilecekler" %>
...
<head id="Head1" runat="server">
    ...
    <title>Fatura Kesilecekleri Belirle</title>
    ...
    <script type="text/javascript">
        function AktiveEt(id) {
            if (window.confirm('İlgili Üyelik İçin Fatura Kesildi mi?')) {
