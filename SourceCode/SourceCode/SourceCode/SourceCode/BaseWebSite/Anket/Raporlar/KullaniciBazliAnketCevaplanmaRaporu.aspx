<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KullaniciBazliAnketCevaplanmaRaporu.aspx.cs" Inherits="BaseWebSite.Anket.Raporlar.KullaniciBazliAnketCevaplanmaRaporu" %>
...
<body>
    ...
    <div class="page_report">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="620px">
            <LocalReport ReportPath="Anket\Raporlar\KullaniciBazliAnketCevaplanmaRaporu.rdlc">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="BaseWebSite.Anket.Raporlar.KullaniciBazliAnketCevaplanmaRaporuDataSetTableAdapters.sbr_kullanici_bazli_cevaplanma_raporu_spTableAdapter">
            <SelectParameters>
