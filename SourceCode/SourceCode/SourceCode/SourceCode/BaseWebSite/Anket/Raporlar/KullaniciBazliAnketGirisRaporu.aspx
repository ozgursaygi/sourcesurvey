<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KullaniciBazliAnketGirisRaporu.aspx.cs" Inherits="BaseWebSite.Anket.Raporlar.KullaniciBazliAnketGirisRaporu" %>
...
<body>
    ...
    <div class="page_report">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="620px">
            <LocalReport ReportPath="Anket\Raporlar\KullaniciBazliAnketGirisRaporu.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
            ...
            TypeName="BaseWebSite.Anket.Raporlar.KullaniciBazliAnketGirisRaporuDataSetTableAdapters.sbr_kullanici_bazli_giris_raporu_spTableAdapter">
            <SelectParameters>
